...
namespace {
    const std::vector<MapLevel> levels {
        ...
        MapLevel {.mLevelIndex = 9, .mPosition = {-5.5f, 1.0f, 10.0f}},
        MapLevel {.mLevelIndex = 10, .mPosition = {-9.2f, 1.5f, 10.0f}},
        MapLevel {.mLevelIndex = 11, .mPosition = {-13.0f, 1.0f, 10.0f}},
        MapLevel {.mLevelIndex = 12, .mPosition = {-17.0f, 1.0f, 10.0f}},
        MapLevel {.mLevelIndex = 13, .mPosition = {-20.f, 0.0f, 10.0f}},
