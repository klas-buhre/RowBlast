...
void RestartConfirmationDialogController::SetUp(SlidingMenuAnimation::UpdateFade updateFadeOnStart) {
    mView.SetUp();
    mSlidingMenuAnimation.SetUp(updateFadeOnStart, SlidingMenuAnimation::SlideDirection::Scale);
}
