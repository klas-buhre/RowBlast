#ifndef OutOfMovesContinueDialogView_hpp
#define OutOfMovesContinueDialogView_hpp
...
namespace RowBlast {
    ...
    class OutOfMovesContinueDialogView: public Pht::GuiView {
    public:
        OutOfMovesContinueDialogView(Pht::IEngine& engine, const CommonResources& commonResources);
