...
namespace {
    ...
    const std::vector<BlockPathVolume> blockPaths {
        ...
        BlockPathVolume {{-19.0f, 4.0f, 12.0f}, {0.0f, 0.0f, 0.0f}, FloatingPieceType::L},
        ...
        BlockPathVolume {{-12.0f, -4.0f, 13.7f}, {0.0f, 0.0f, 0.0f}, FloatingPieceType::RowBomb},
        BlockPathVolume {{-10.0f, 0.5f, 7.0f}, {0.0f, 0.0f, 0.0f}, FloatingPieceType::Bomb, .mBlockRotation = Pht::Vec3{45.0f, 0.0f, 45.0f}},
