...
namespace RowBlast {
    ...
    public:
        ...
        const Pht::Material& GetGoldStarMaterial() const {
            return *mGoldStarMaterial;
        }
    ...
    private:
        ...
        void CreateGoldStarMaterial(const Pht::EnvMapTextureFilenames& envMapTextures);
        ...
        std::unique_ptr<Pht::Material> mGoldStarMaterial;
